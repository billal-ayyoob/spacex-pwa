...
function prepareGatewayDocument(originalDocument, transformedSchema, returnType, infoSchema) {
    ...
    var expandedDocument = {
        ...
        definitions: tslib.__spreadArray(tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(operations)), tslib.__read(fragments)), tslib.__read(expandedFragments)),
    };
...
var sortSubschemasByProxiability = memoize4(function sortSubschemasByProxiability(mergedTypeInfo, sourceSubschemaOrSourceSubschemas, targetSubschemas, fieldNodes) {
    ...
    try {
        for (var targetSubschemas_1 = tslib.__values(targetSubschemas), targetSubschemas_1_1 = targetSubschemas_1.next(); !targetSubschemas_1_1.done; targetSubschemas_1_1 = targetSubschemas_1.next()) {
        ...
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all(tslib.__spreadArray([], tslib.__read(delegationMap.entries())).map(function (_a) {
                                    ...
                                    switch (_d.label) {
                                        ...
                                        case 4:
                                            if (source instanceof Error || source === null) {
                                                fieldNodes_2 = execute_js.collectFields({
                                                    schema: info.schema,
                                                    variableValues: {},
                                                    fragments: {},
                                                ...
                                                for (responseKey in fieldNodes_2) {
                                                    combinedPath = tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(path)), [responseKey]);
                                                    if (source instanceof graphql.GraphQLError) {
                                                        nullResult[responseKey] = utils.relocatedError(source, combinedPath);
                                                    }
                                                    else if (source instanceof Error) {
                                                        nullResult[responseKey] = graphql.locatedError(source, fieldNodes_2[responseKey], combinedPath);
                                                    }
                                                    else {
                                                ...
                                                if (source[UNPATHED_ERRORS_SYMBOL]) {
                                                    combinedErrors.push.apply(combinedErrors, tslib.__spreadArray([], tslib.__read(source[UNPATHED_ERRORS_SYMBOL])));
                                                }
                                            }
                ...
                case 1:
                    results = _d.sent();
                    combinedResult = Object.assign.apply(Object, tslib.__spreadArray([{}, object], tslib.__read(results)));
...
function typesContainSelectionSet(types, selectionSet) {
    ...
    var _loop_2 = function (selection) {
        ...
        else if (selection.kind === graphql.Kind.INLINE_FRAGMENT && ((_b = selection.typeCondition) === null || _b === void 0 ? void 0 : _b.name.value) === types[0].name) {
            return { value: typesContainSelectionSet(types, selection.selectionSet) };
        }
    };
    try {
        for (var _c = tslib.__values(selectionSet.selections), _d = _c.next(); !_d.done; _d = _c.next()) {
...
function collectSubFields(info, typeName) {
    ...
    try {
        for (var _b = tslib.__values(info.fieldNodes), _c = _b.next(); !_c.done; _c = _b.next()) {
...
var getFieldsNotInSubschema = memoizeInfoAnd2Objects(function getFieldsNotInSubschemaMemoized(info, subschema, mergedTypeInfo) {
    ...
    for (var responseKey in subFieldNodes) {
        ...
        if (!fields[fieldName]) {
            try {
                for (var subFieldNodesForResponseKey_1 = (e_2 = void 0, tslib.__values(subFieldNodesForResponseKey)), subFieldNodesForResponseKey_1_1 = subFieldNodesForResponseKey_1.next(); !subFieldNodesForResponseKey_1_1.done; subFieldNodesForResponseKey_1_1 = subFieldNodesForResponseKey_1.next()) {
        ...
        if (fieldNodesForField) {
            try {
                for (var fieldNodesForField_1 = (e_3 = void 0, tslib.__values(fieldNodesForField)), fieldNodesForField_1_1 = fieldNodesForField_1.next(); !fieldNodesForField_1_1.done; fieldNodesForField_1_1 = fieldNodesForField_1.next()) {
    ...
    try {
        for (var errorMap_1 = tslib.__values(errorMap), errorMap_1_1 = errorMap_1.next(); !errorMap_1_1.done; errorMap_1_1 = errorMap_1.next()) {
            ...
            if (data[pathSegment] !== undefined) {
                ...
                unpathedErrors.push.apply(unpathedErrors, tslib.__spreadArray([], tslib.__read(newErrors)));
            }
            else {
                unpathedErrors.push.apply(unpathedErrors, tslib.__spreadArray([], tslib.__read(pathSegmentErrors)));
            }
        }
    }
    catch (e_2_1) { e_2 = { error: e_2_1 }; }
