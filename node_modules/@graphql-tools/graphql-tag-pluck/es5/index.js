...
function generateConfig(filePath, code, _options) {
    ...
    switch (fileExt) {
        ...
        case '.js':
            plugins.push.apply(plugins, tslib.__spreadArray(['jsx'], tslib.__read(dynamicFlowPlugins)));
            break;
        case '.jsx':
            plugins.push.apply(plugins, tslib.__spreadArray(['jsx'], tslib.__read(dynamicFlowPlugins)));
            break;
        case '.flow.js':
            plugins.push.apply(plugins, tslib.__spreadArray(['jsx'], tslib.__read(flowPlugins)));
            break;
        case '.flow.jsx':
            plugins.push.apply(plugins, tslib.__spreadArray(['jsx'], tslib.__read(flowPlugins)));
            break;
