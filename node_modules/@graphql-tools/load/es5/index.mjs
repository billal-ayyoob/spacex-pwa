...
import { asArray, isDocumentString, parseGraphQLSDL, getDocumentNodeFromSchema, fixSchemaAst, printSchemaWithDirectives, printWithComments, resetComments, compareStrings } from '@graphql-tools/utils/es5';
...
function getCustomLoaderByPath(path, cwd) {
    try {
        var requireFn = createRequire(cwd);
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    (_b = options.ignore).push.apply(_b, __spreadArray([], __read(ignore)));
