...
var ApolloEngineLoader = /** @class */ (function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, crossFetch.fetch.apply(void 0, tslib.__spreadArray([], tslib.__read(fetchArgs)))];
                    case 2:
                        response = _b.sent();
    ...
    ApolloEngineLoader.prototype.loadSync = function (pointer, options) {
        ...
        var response = syncFetch.apply(void 0, tslib.__spreadArray([], tslib.__read(fetchArgs)));
