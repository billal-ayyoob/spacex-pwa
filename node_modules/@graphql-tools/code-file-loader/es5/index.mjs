import { __values, __awaiter, __generator, __assign, __spreadArray, __read } from 'tslib';
import { isSchema, parse, buildClientSchema, concatAST } from 'graphql';
...
function flattenSources(sources, options) {
    var documents = sources.map(function (source) { return parse(source, options); });
