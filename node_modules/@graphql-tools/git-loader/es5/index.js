            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                            child_process.execFile('git', createTreeCommand({ ref: ref }), { encoding: 'utf-8', maxBuffer: 1024 * 1024 * 1024 }, function (error, stdout) {
                                if (error) {
                                    reject(error);
                                }
                                else {
...
function readTreeAtRefSync(ref) {
    try {
        return child_process.execFileSync('git', createTreeCommand({ ref: ref }), { encoding: 'utf-8' })
            .split(os.EOL)
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                            child_process.execFile('git', createShowCommand(input), { encoding: 'utf-8', maxBuffer: 1024 * 1024 * 1024 }, function (error, stdout) {
                                if (error) {
                                    reject(error);
                                }
                                else {
...
var GitLoader = /** @class */ (function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        try {
                            for (ignores_1 = tslib.__values(ignores), ignores_1_1 = ignores_1.next(); !ignores_1_1.done; ignores_1_1 = ignores_1.next()) {
                        ...
                        resolved = [];
                        return [4 /*yield*/, Promise.all(tslib.__spreadArray([], tslib.__read(refsForPaths.entries())).map(function (_a) {
                                var _b = tslib.__read(_a, 2), ref = _b[0], paths = _b[1];
                                return tslib.__awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return tslib.__generator(this, function (_h) {
                                        switch (_h.label) {
                                            ...
                                            case 1:
                                                _d.apply(_c, _e.concat([tslib.__spreadArray.apply(void 0, _f.concat([tslib.__read.apply(void 0, [_g.apply(void 0, [_h.sent(), paths]).map(function (filePath) { return "git:" + ref + ":" + filePath; })])]))]));
                                                return [2 /*return*/];
                                        }
                                    });
                                });
    ...
    GitLoader.prototype.resolveGlobsSync = function (glob, ignores) {
        ...
        refsForPaths.get(ref).push(unixify(path));
        try {
            for (var ignores_2 = tslib.__values(ignores), ignores_2_1 = ignores_2.next(); !ignores_2_1.done; ignores_2_1 = ignores_2.next()) {
        ...
        var _loop_1 = function (ref_3, paths) {
            resolved.push.apply(resolved, tslib.__spreadArray([], tslib.__read(micromatch(readTreeAtRefSync(ref_3), paths).map(function (filePath) { return "git:" + ref_3 + ":" + filePath; }))));
        };
        try {
            for (var _c = tslib.__values(refsForPaths.entries()), _d = _c.next(); !_d.done; _d = _c.next()) {
                var _e = tslib.__read(_d.value, 2), ref_3 = _e[0], paths = _e[1];
                _loop_1(ref_3, paths);
            }
        }
    ...
    GitLoader.prototype.load = function (pointer, options) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var result, path, finalResult, resolvedPaths, results, results_1, results_1_1, result_1;
            var e_4, _a;
            var _this = this;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        path = result.path;
                        finalResult = [];
                        if (!isGlob(path)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.resolveGlobs(pointer, utils.asArray(options.ignore || []))];
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(resolvedPaths.map(function (path) { return tslib.__awaiter(_this, void 0, void 0, function () {
                                var results, results_2, results_2_1, result_2;
                                var e_5, _a;
                                return tslib.__generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 1:
                                            results = _b.sent();
                                            try {
                                                for (results_2 = tslib.__values(results), results_2_1 = results_2.next(); !results_2_1.done; results_2_1 = results_2.next()) {
                                                    result_2 = results_2_1.value;
                    ...
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 6];
                    case 3: return [4 /*yield*/, this.canLoad(pointer)];
                    case 4:
                    ...
                    case 5:
                        ...
                        _b.label = 6;
                    case 6: return [2 /*return*/, finalResult];
                }
            });
        });
    };
    GitLoader.prototype.handleSingularPointerSync = function (pointer, options) {
        ...
        var sources = graphqlTagPluck.gqlPluckFromCodeStringSync(pointer, content, options.pluckConfig);
    ...
    GitLoader.prototype.loadSync = function (pointer, options) {
        ...
        var finalResult = [];
        if (isGlob(path)) {
            var resolvedPaths = this.resolveGlobsSync(pointer, utils.asArray(options.ignore || []));
            var finalResult_1 = [];
            try {
                for (var resolvedPaths_1 = tslib.__values(resolvedPaths), resolvedPaths_1_1 = resolvedPaths_1.next(); !resolvedPaths_1_1.done; resolvedPaths_1_1 = resolvedPaths_1.next()) {
                    ...
                    if (this.canLoadSync(path_3)) {
                        ...
                        try {
                            for (var results_3 = (e_7 = void 0, tslib.__values(results)), results_3_1 = results_3.next(); !results_3_1.done; results_3_1 = results_3.next()) {
                                var result_3 = results_3_1.value;
                                finalResult_1.push(result_3);
                            }
                        }
            ...
            try {
                for (var results_4 = tslib.__values(results), results_4_1 = results_4.next(); !results_4_1.done; results_4_1 = results_4.next()) {
                    var result_4 = results_4_1.value;
                    finalResult.push(result_4);
                }
            }
            catch (e_8_1) { e_8 = { error: e_8_1 }; }
            finally {
                try {
                    if (results_4_1 && !results_4_1.done && (_c = results_4.return)) _c.call(results_4);
                }
