...
import os from 'os';
import { parseGraphQLSDL, parseGraphQLJSON, asArray } from '@graphql-tools/utils/es5';
...
var GitLoader = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        resolved = [];
                        return [4 /*yield*/, Promise.all(__spreadArray([], __read(refsForPaths.entries())).map(function (_a) {
                                ...
                                return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_h) {
                                        switch (_h.label) {
                                            ...
                                            case 1:
                                                _d.apply(_c, _e.concat([__spreadArray.apply(void 0, _f.concat([__read.apply(void 0, [_g.apply(void 0, [_h.sent(), paths]).map(function (filePath) { return "git:" + ref + ":" + filePath; })])]))]));
                                                return [2 /*return*/];
                                        }
                                    });
                                });
    ...
    GitLoader.prototype.resolveGlobsSync = function (glob, ignores) {
        ...
        var _loop_1 = function (ref_3, paths) {
            resolved.push.apply(resolved, __spreadArray([], __read(micromatch(readTreeAtRefSync(ref_3), paths).map(function (filePath) { return "git:" + ref_3 + ":" + filePath; }))));
        };
        try {
            ...
            try {
                for (var resolvedPaths_1 = __values(resolvedPaths), resolvedPaths_1_1 = resolvedPaths_1.next(); !resolvedPaths_1_1.done; resolvedPaths_1_1 = resolvedPaths_1.next()) {
                    ...
                    if (this.canLoadSync(path_3)) {
                        ...
                        try {
                            for (var results_3 = (e_7 = void 0, __values(results)), results_3_1 = results_3.next(); !results_3_1.done; results_3_1 = results_3.next()) {
